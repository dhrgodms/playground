...
function UpdatePostPage() {
    ...
    const handleDelete = () => {
        axios.delete(`http://ok-archive.com:8080/api/post/delete/${id}`).then(response => {
    ...
    const SettingUserThumbnail = () => {
        ...
        const onDeleteImage = useCallback(e => {
            ...
            axios.get(`http://ok-archive.com:8080/api/post/thumbnail-delete/${id}`,{
                'Content-Type': 'multipart/form-data',
            },)
                .then(response => {
                    console.log(response);
                    setFormData({...formData,thumbnail:"http://ok-archive.com:8080/thumbnail/white.jpg"});
                    console.log(formData.thumbnail);
                })
                .catch(error => {
                    console.error(error);
    ...
    async function handleSubmit(e) {
        ...
        try {
            axios
                .post('http://ok-archive.com:8080/api/post/update', {
                    id:id,
