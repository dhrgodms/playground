...
const WritePost = () => {
    ...
    const [writePost, setWritePost] = useState({id:1, thumbnail:'http://ok-archive.com:8080/white.jpg',contentTitle:""});
    ...
    async function handleCommentSubmit(e) {
        ...
        try {
            axios
                .post('http://ok-archive.com:8080/api/comment/add', {
    ...
    async function handleLikes(e) {
        ...
        try {
            axios
                .get(`http://ok-archive.com:8080/api/post/like/${id}`)
                .then(res => {
                    console.log(res);
                    if (res?.data) {
    ...
    useEffect(() => {
        ...
        (writePost.id<2)&&axios.get(`http://ok-archive.com:8080/api/post/${id}`).then(response => {
            setWritePost(response.data);
            setIsLoaded(true);
        }).catch(error=>console.log(error));
        axios.get(`http://ok-archive.com:8080/api/comment/all/${id}`).then(response => {
            setCommentAll(response.data);
        }).catch(error=>console.log(error));
        console.log(writePost.tag);
        (writePost.tag===2&&images.length<1)&&axios.get(`http://ok-archive.com:8080/api/image/all/${id}`).then(response => {
