...
const GuestBook = () => {
    ...
    useEffect(() => {
        (guestbook?.length < 2) && axios.get('http://ok-archive.com:8080/api/guestbook/all').then(response => setguestbook(response.data)).catch(error => console.log(error));
    ...
    async function handleCommentSubmit(e) {
        ...
        try {
            axios
                .post('http://ok-archive.com:8080/api/guestbook/add', {
    ...
    async function handleModify(e) {
        ...
        try {
            axios
                .post(`http://ok-archive.com:8080/api/guestbook/modify/${id}`, {
                    memberName: guestbookData.commentNickname,
                    memberPassword: guestbookData.commentPassword,
                    content: guestbookData.commentContent,
                })
